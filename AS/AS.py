...
def get_fs_body(as_ip, as_port):
    ...
    while True:
        ...
        fs_address = bytes_address_pair[1]
...
def dns_us_request_response(as_ip, as_port):
    ...
    while True:
        ...
        us_address = bytes_address_pair[1]
...
US_Values = dns_us_request_response(AS_IP, AS_Port)  # This returns that data sent by US server and  its address
US_Dict = US_Values[0]
